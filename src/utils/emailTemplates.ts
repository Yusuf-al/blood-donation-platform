...
export const forgetEmailSendEmailTemplates = (otp: string, name: string) => {
  return `<div style="max-width:480px; margin:40px auto; background:#fff; border-radius:14px; overflow:hidden; box-shadow:0 6px 20px rgba(0,0,0,.06);">
     <div style="padding:24px; text-align:center; border-bottom:1px solid #eee;"> 
     <h2 style="margin:0; color:#d62839;">FAST<span style="color:#263238;">Blood</span></h2> 
     <p style="margin:6px 0 0; font-size:12px; color:#888;">Forget Password</p> 
     </div> <div style="padding:30px;"> <h3 style="margin:0 0 12px; color:#172b4d;">Reset your password</h3> 
     <p style="font-size:14px; line-height:1.7; color:#5f6c7b;"> Hello <strong>${name}</strong>,<br /> 
     Use the OTP below to reset password. </p> <div style="margin:24px 0; padding:20px; text-align:center; background:#fff1f2; border:1px solid #ffd9dd; border-radius:10px;">
      ...
      </div> <p style="margin:0; font-size:12px; line-height:1.6; color:#8a94a3;"> If you didn't request, simply ignore this email. Never share your OTP. </p> 
      </div> 
